...
define([
	...
	return register("d-textbox", [HTMLElement, FormValueWidget], /** @lends module:deliteful/Textbox# */ {
		...
		/**
		 * The maxLength corresponding to the HTML input maxLength property.
		...
		/**
		 * The minLength corresponding to the HTML input minLength property.
		 * If the value of the type attribute is text, email, search, password, tel, or url, this attribute specifies
		 * the minimum number of characters (in Unicode code points) that the user must enter.
		 * @member {number}
		 * @default 0
		 */
		minLength: -1,
